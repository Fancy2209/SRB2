...
#define NOMOREJOYBTN_1S
	...
	{KEY_JOY1+13, "JOYZL"},
	{KEY_JOY1+14, "JOYZR"},
	{KEY_JOY1+5,  "JOYMINUS_CC"},
	{KEY_JOY1+4,  "JOYHPLUS_CC"},
	{KEY_JOY1+6,  "JOYMHOME_CC"},
#define NOMOREJOYBTN_1S
#else
	{KEY_JOY1+0, "JOY1"},
	{KEY_JOY1+1, "JOY2"},
...
#define NOMOREJOYBTN_1DBL
	...
	{KEY_JOY1+2,  "DBLJOY1"},
	{KEY_JOY1+3,  "DBLJOY2"},
	{KEY_JOY1+5,  "DBLJOYMINUS"},
	{KEY_JOY1+4,  "DBLJOYPLUS"},
	{KEY_JOY1+6,  "DBLJOYHOME"},
	{KEY_JOY1+7,  "DBLJOYZ"},
	{KEY_JOY1+8,  "DBLJOYC"},
	{KEY_JOY1+0,  "DBLJOYA_CC"},
	{KEY_JOY1+1,  "DBLJOYB_CC"},
	{KEY_JOY1+9,  "DBLJOYX"},
	{KEY_JOY1+10, "DBLJOYY"},
	{KEY_JOY1+11, "DBLJOYL"},
	{KEY_JOY1+12, "DBLJOYR"},
	{KEY_JOY1+13, "DBLJOYZL"},
	{KEY_JOY1+14, "DBLJOYZR"},
	{KEY_JOY1+5,  "DBLJOYMINUS_CC"},
	{KEY_JOY1+4,  "DBLJOYHPLUS_CC"},
	{KEY_JOY1+6,  "DBLJOYMHOME_CC"},
#define NOMOREJOYBTN_1DBL
#else
...
#define NOMOREJOYBTN_2S
	...
	{KEY_2JOY1+5,  "SEC_JOYMINUS"},
	{KEY_2JOY1+4,  "SEC_JOYPLUS"},
	{KEY_2JOY1+6,  "SEC_JOYHOME"},
	{KEY_2JOY1+7,  "SEC_JOYZ"},
	{KEY_2JOY1+8,  "SEC_JOYC"},
	{KEY_2JOY1+0,  "SEC_JOYA_CC"},
	{KEY_2JOY1+1,  "SEC_JOYB_CC"},
	{KEY_2JOY1+9,  "SEC_JOYX"},
	{KEY_2JOY1+10, "SEC_JOYY"},
	{KEY_2JOY1+11, "SEC_JOYL"},
	{KEY_2JOY1+12, "SEC_JOYR"},
	{KEY_2JOY1+13, "SEC_JOYZL"},
	{KEY_2JOY1+14, "SEC_JOYZR"},
	{KEY_2JOY1+5,  "SEC_JOYMINUS_CC"},
	{KEY_2JOY1+4,  "SEC_JOYHPLUS_CC"},
	{KEY_2JOY1+6,  "SEC_JOYMHOME_CC"},
#define NOMOREJOYBTN_2S
#else
...
#define NOMOREJOYBTN_2SDBL
	...
	{KEY_DBL2JOY1+5,  "DBLSEC_JOYMINUS"},
	{KEY_DBL2JOY1+4,  "DBLSEC_JOYPLUS"},
	{KEY_DBL2JOY1+6,  "DBLSEC_JOYHOME"},
	{KEY_DBL2JOY1+7,  "DBLSEC_JOYZ"},
	{KEY_DBL2JOY1+8,  "DBLSEC_JOYC"},
	{KEY_DBL2JOY1+0,  "DBLSEC_JOYA_CC"},
	{KEY_DBL2JOY1+1,  "DBLSEC_JOYB_CC"},
	{KEY_DBL2JOY1+9,  "DBLSEC_JOYX"},
	{KEY_DBL2JOY1+10, "DBLSEC_JOYY"},
	{KEY_DBL2JOY1+11, "DBLSEC_JOYL"},
	{KEY_DBL2JOY1+12, "DBLSEC_JOYR"},
	{KEY_DBL2JOY1+13, "DBLSEC_JOYZL"},
	{KEY_DBL2JOY1+14, "DBLSEC_JOYZR"},
	{KEY_DBL2JOY1+5,  "DBLSEC_JOYMINUS_CC"},
	{KEY_DBL2JOY1+4,  "DBLSEC_JOYHPLUS_CC"},
	{KEY_DBL2JOY1+6,  "DBLSEC_JOYMHOME_CC"},
#define NOMOREJOYBTN_2DBL
#else
